...
# Folder where current data stored

data_inputs <- "N:\\Quantitative-Ecology\\Simone\\extinction_test\\outputs\\version_3\\2021-05-04_manuscript_outputs\\2021-11-10\\MS_v6_data_outputs"
...
files_paths <- list.files(data_inputs, full.names = TRUE)
...
rank_rli_bhi_scatterplot_data <- input_data %>% 
                            ...
                            mutate(cluster_label = factor(cluster_label, 
                               levels = c("Cluster one","Cluster two",
                                          "Cluster three"))) %>% 
                            mutate(BHI_rank_order = rank(BHI_plants_2005, "last"),
