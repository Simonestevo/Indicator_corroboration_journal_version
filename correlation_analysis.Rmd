...
correlations_edited <- all_correlations %>% 
                       ...
                       mutate(corr_level = ifelse(coefficient > -0.3 & # assign the rankings
                                           ...
                                           ifelse(coefficient == 0,
                                                  "no-relationship",
                                                  "NA"))))))) %>% 
                       mutate(corr_level = factor(corr_level, levels = c("proxy-redundant",
                                                                         "complementary",
                                                                         "weak",
                                                                         "no-relationship"))) %>%
...
corr_level <- rep(red, times = length(Ind1))
...
corr_level <- rep("proxy-redundant", times = length(Ind1))
coeff_label <- rep("1.00",
                   times = length(Ind1))
