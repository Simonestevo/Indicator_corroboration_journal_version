...
# Create a folder for wip and data

exploratory_outputs <- file.path(current_analysis_outputs, "exploratory_outputs")

dir.create(exploratory_outputs, recursive = TRUE ) # create a new directory for today's outputs
...
saveRDS(indicator_correlation_matrix_lpi,
        file.path(exploratory_outputs, "indicator_correlation_matrix_lpi.RDS"))

write.csv(indicator_correlation_matrix_lpi,
          file.path(exploratory_outputs, "indicator_correlation_matrix_lpi.csv"))
...
saveRDS(indicator_correlation_matrix,
        file.path(exploratory_outputs, "indicator_correlation_matrix.RDS"))

write.csv(indicator_correlation_matrix,
          file.path(exploratory_outputs, "indicator_correlation_matrix.csv"))
...
saveRDS(ecoregions_correlation_matrix,
        file.path(exploratory_outputs, "ecoregion_numerical_correlations.RDS"))

write.csv(ecoregions_correlation_matrix,
          file.path(exploratory_outputs, "ecoregion_numerical_correlations.csv"))
...
write.csv(indicators_ecoregions_correlation_matrix,
          file.path(exploratory_outputs, "indicators_ecoregions_correlation_matrix"))
...
write.csv(categorical_independence_output,
          file.path(exploratory_outputs, "ecoregion_categorical_correlations.csv"))
...
write.csv(chi_sq_matrix_stat,
          file.path(exploratory_outputs, "chi_sq_statistic_matrix.csv"))
...
for ( i in seq_along(ecoregions_list)) {
  ...
  for(j in seq_along(numeric_variables)) {
    ...
    ggsave(file.path(exploratory_outputs, plotname),
           group_numerics[[j]],
           device = "png")
